...
class Button:
    ...
    def draw(self, win):
        ...
        pygame.draw.rect(win, self.color, (self.x, self.y, self.scaled_width, self.scaled_height), border_radius=15)
    ...
    def hover(self, pos):
        ...
        if self.x <= x1 <= self.x + self.width and self.y <= y1 <= self.y + self.height:
            ...
            self.scaled_width = int(self.width * 1.1)
            self.scaled_height = int(self.height * 1.1)
        else:
...
def draw_background():
    ...
    # Draw grid lines
    for i in range(0, height, 50):  # Horizontal lines
        pygame.draw.line(win, (80, 80, 80), (0, i), (width, i))
    for i in range(0, width, 50):   # Vertical lines
        pygame.draw.line(win, (80, 80, 80), (i, 0), (i, height))
